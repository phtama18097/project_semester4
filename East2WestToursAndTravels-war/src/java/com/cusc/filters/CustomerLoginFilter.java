 ...
 */
package com.cusc.filters;

import com.cusc.beans.CustomerLoginMB;
...
public class CustomerLoginFilter implements Filter {
    ...
    @Inject
    private CustomerLoginMB customterLoginMB;
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("CustomerLoginFilter:DoBeforeProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            if(customterLoginMB.getCusSignedIn()== null || !customterLoginMB.isIsLoggedIn()){
                if(url.contains("/checkout.xhtml") || url.contains("/profile.xhtml") || url.contains("/changePassword.xhtml") || url.contains("/carRegistration.xhtml") || url.contains("/carRegistrationDetail.xhtml") || url.contains("/tourRegistration.xhtml") || url.contains("/tourRegistrationDetail.xhtml")){
                    wrappedResponse.sendRedirect(wrappedRequest.getServletContext().getContextPath() + "/faces/client/customerLoginPage.xhtml");
                } else {
                    chain.doFilter(wrappedRequest, wrappedResponse);
                }
            }else{
                if(url.contains("/customerLoginPage.xhtml") || url.contains("/register.xhtml")){
                    wrappedResponse.sendRedirect(wrappedRequest.getServletContext().getContextPath() + "/faces/client/homepage.xhtml");
                } else {
                    chain.doFilter(wrappedRequest, wrappedResponse);
                }
            }
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("CustomerLoginFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("CustomerLoginFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("CustomerLoginFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("CustomerLoginFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("CustomerLoginFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
