...
import com.cusc.beans.EmployeeLoginMB;
...
public class EmployeeLoginFilter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("EmployeeLoginFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("EmployeeLoginFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("EmployeeLoginFilter:doFilter()");
        }
        ...
        try {
            if (employeeLoginMB.getEmpSignedIn() == null || !employeeLoginMB.isIsLoggedIn()) {
                if (url.contains("/faces/admin/")) {
                    wrappedResponse.sendRedirect(wrappedRequest.getServletContext().getContextPath() + "/faces/adminLoginPage.xhtml");
                } else {
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("EmployeeLoginFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("EmployeeLoginFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("EmployeeLoginFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("EmployeeLoginFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("EmployeeLoginFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
