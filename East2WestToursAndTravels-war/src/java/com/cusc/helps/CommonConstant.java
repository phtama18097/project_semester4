...
public class CommonConstant {
    ...
    /**
     *
     * @constants are used notice
     */
    public static final String IMAGE_IS_NULL_NOTICE = "The image field must not be blank.";
    public static final String UPLOADING_FAIL_NOTICE = "Uploading file is failed. Try again!";
